...
export default function NewItem({ onAddItem }) {
    ...
    return (
        <div>
            <form onSubmit={submitFunction} className="bg-purple-600 p-6 rounded-lg shadow-md w-full max-w-md mb-2">
                <div className="flex flex-col items-center space-y-4">
                    ...
                    <button
                        type="submit"
                        className="w-full bg-purple-700 text-white px-4 py-2 rounded-md hover:bg-purple-400"
                    >
                        Submit
                    </button>
                </div>
